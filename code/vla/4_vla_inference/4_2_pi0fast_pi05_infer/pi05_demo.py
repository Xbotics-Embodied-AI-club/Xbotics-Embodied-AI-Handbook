...
SEED = 7
OUT_PATH = Path("vla/4_vla_inference/4_2_pi0fast_pi05_infer/output/pi05_libero_success.mp4")
...
def main() -> None:
    ...
    try:
        ...
        for _ in range(MAX_STEPS):
            ...
            # π0.5 每次根据当前观测用 flow matching 去噪出一个动作块，
