...
| 第五部分 L17–L18 | **新梦**（雨浩协同） | `docs/part5-vln/`、`code/lecture17–18` |
| 第六部分 L19、L20–L21 | 雨浩（富平 L19、煜恒 L20） | `docs/part6-agent-world-model/`、`code/lecture19、20–21` |
...
- **完整约定**（标题、配图、定稿清单、迁移优先级）：[`docs/style-guide.md`](docs/style-guide.md)
- **摘要**： [README § 课程内容风格](README.md#writing-style)

**四点原则**：简单直接 · 任务驱动 · 讲清楚再实验 · 重视失败复盘（完整约定含「讲清楚优先」见风格指南 §0）
