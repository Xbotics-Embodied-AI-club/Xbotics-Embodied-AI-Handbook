# 第六部分：具身前沿 —— Agent、世界模型与进展（第 19、20–21 讲）

## 部分定位

第六部分是原「具身前沿」大章中除 VLN 以外的内容：**Embodied Agent**（任务规划与 Skill 调度）、**世界模型**（未来预测、动作生成、学习型仿真与数据飞轮）、**前沿进展**（方向梳理 + 全课综合答辩）。

VLN 已独立为 **第五部分**（第 17–18 讲）。

## 覆盖讲次

| 讲次 | 主题 | 协同 |
|------|------|------|
| 第 19 讲 | Embodied Agent | 富平（Agent） |
| 第 20 讲 | 世界模型 —— 预测、规划与数据飞轮 | 煜恒（世界模型） |
| 第 21 讲 | 具身智能前沿进展 —— 综合闭环与答辩 | 雨浩组 |

**负责人**：雨浩（主责）

## 第 19 讲大纲：Embodied Agent
...
| 推荐顺序 | 讲次 | 说明 |
|----------|------|------|
| 1 | L17–L18 VLN | 补齐语言导航 skill |
| 2 | L19 Agent | 规划与技能调用框架 |
| 3 | L20 世界模型 | 预测、动作生成与学习型仿真 |
| 4 | L21 前沿与答辩 | 综合闭环 |
