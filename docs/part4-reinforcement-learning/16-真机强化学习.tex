...
次迭代，SAC 约 15 分钟、PPO 约 103 分钟；SAC 那条在头 4
分钟里就走完了全部涨幅，剩下的 11 分钟一路往下走}
...
\begin{center}
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{\dimexpr 0.1950\linewidth - 2\tabcolsep\relax} >{\raggedright\arraybackslash}p{\dimexpr 0.2843\linewidth - 2\tabcolsep\relax} >{\raggedright\arraybackslash}p{\dimexpr 0.2414\linewidth - 2\tabcolsep\relax} >{\raggedright\arraybackslash}p{\dimexpr 0.2794\linewidth - 2\tabcolsep\relax}@{}}
\toprule\noalign{}
 & 第14讲 & 第15讲 & 第16讲 \\
\midrule\noalign{}
...
本讲演示阶梯 & REINFORCE→A2C→PPO & 单一 GRPO & 表格Q→DQN→DDPG→TD3→SAC（off-policy 五级） \\
\bottomrule\noalign{}
\end{tabular}
\end{center}
